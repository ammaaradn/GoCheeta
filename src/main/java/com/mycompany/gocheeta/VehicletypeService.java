...
public class VehicletypeService {
    ...
    public String getVehicletypes() {
        ...
        return gson.toJson(utils.getVehicletypes());
    ...
    public String getVehicletype( ) {
        DBUtils utils = new DBUtils();
        Gson gson = new GsonBuilder().create();
        return gson.toJson(utils.getVehicletype("1"));
    }
    ...
    public Response addVehicletype(String json) {
        ...
        boolean result = utils.addVehicletype(vehicletype);
    ...
    public Response updateVehicletype(String json) {
        ...
        Gson gson = new GsonBuilder().create();
        Vehicletype vehicletype = gson.fromJson(json, Vehicletype.class);
        boolean result = utils.updateVehicletype(vehicletype);
    ...
    @DELETE
    @Path("/{id}")
    public Response deleteVehicletype(@PathParam("id") String id) {
        DBUtils utils = new DBUtils();
        boolean result = utils.deleteVehicletype(id);
        if (result) {
